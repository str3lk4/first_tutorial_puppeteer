const puppeteer = require("puppeteer"); // importa o pacote puppeteer
const createCsvWriter = require("csv-writer").createObjectCsvWriter; // importa o pacote csv-writer
