...
let scrape = async () => { // crie uma função assíncrona que irá realizar o scraping
    ...
    await page.goto("https://www.amazon.com.br/"); // define a página que queremos acessar e a função goto navega até essa página.

    const urls = await page.$$eval("a" /* seletor desejado */, (el) => {
